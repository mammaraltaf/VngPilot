...
<script>
	function change_myselect(sel1) {
		...
		for(let car of cars){
			...
			{
				lats.push(car["geometry.location.lat"])
				longs.push(car["geometry.location.lng"])
						...
						<div class="container-fluid">
							...
							<div class="header-brand me-5">
								...
								<a href="index.html">
									...
									<h2 class="fw-bolder" style="color:white;">Irregularities of the auto companies on the map in The Hague </h2>
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Brand-->
